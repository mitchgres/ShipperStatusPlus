...
root_widget_login.title("ShipperStatusPlus - Admin Selection Screen")
...
title_label = Label(user_selection_frame, text="ShipperStatusPlus Admin Selection", font='Helvetica 18 bold', background="#31117A", foreground="#f2f2f2", pady=15)
...
check_package_status_radio = Radiobutton(user_selection_frame, text="Check Package Status", variable=admin_radio_input, value="Check", width=50, pady=7, background="#31117A", foreground="#f2f2f2", font='Helvetica 11 bold')
update_package_status_radio = Radiobutton(user_selection_frame, text="Update Package Status", variable=admin_radio_input, value="Status", width=50, pady=7, background="#31117A", foreground="#f2f2f2", font='Helvetica 11 bold')
edit_user_radio = Radiobutton(user_selection_frame, text="Edit User Information", variable=admin_radio_input, value="Edit User", width=50, pady=7, background="#31117A", foreground="#f2f2f2", font='Helvetica 11 bold')
