...
root_widget_login.title("ShipperStatusPlus - Admin User Information Delete Screen")
...
title_label = Label(admin_user_edit_frame, text="Admin User Information Delete", font='Helvetica 18 bold',
...
delete_user_database_button = Button(admin_user_edit_frame, padx=35, pady=0, text="Delete User Profile",
